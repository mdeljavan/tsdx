...
import { babelPluginUtsdx } from './babelPluginUtsdx';
import { UtsdxOptions } from './types';
...
export async function createRollupConfig(
  ...
  return {
    ...
    external: (id: string) => {
      // bundle in polyfills as UTSDX can't (yet) ensure they're installed as deps
    ...
    treeshake: {
      ...
      // This means utsdx WILL remove getters and setters defined directly on objects.
